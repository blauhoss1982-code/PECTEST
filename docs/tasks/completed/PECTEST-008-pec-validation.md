# PECTEST-008 — Two-checkpoint PEC Collaboration Validation
...
4. Add `docs/reports/PECTEST-008-validation-report.md` containing:
...
3. closeout moves this active task **unchanged** from `docs/tasks/active/PECTEST-008-pec-validation.md` to `docs/tasks/completed/PECTEST-008-pec-validation.md`;
4. closeout updates `docs/CURRENT_STATUS.md` with completion evidence;
5. Planner merges the closeout PR;
6. Planner closes PECTEST Issue #41;
