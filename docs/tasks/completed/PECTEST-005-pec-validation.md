# PECTEST-005 — Two-checkpoint PEC Collaboration Validation
...
4. Add `docs/reports/PECTEST-005-validation-report.md` containing:
   - Task ID and checkpoint `B`;
   - the bound Repository / Branch / Start / Task / Task-blob coordinates from durable project state;
...
3. closeout moves this active task **unchanged** from `docs/tasks/active/PECTEST-005-pec-validation.md` to `docs/tasks/completed/PECTEST-005-pec-validation.md`;
4. closeout updates `docs/CURRENT_STATUS.md` with completion evidence;
5. Planner merges the closeout PR;
6. Planner closes PECTEST Issue #24;
