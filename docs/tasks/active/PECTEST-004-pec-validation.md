# PECTEST-004 — Two-checkpoint PEC Collaboration Validation
...
4. Add `docs/reports/PECTEST-004-validation-report.md` containing:
...
3. move this active task **unchanged** from `docs/tasks/active/PECTEST-004-pec-validation.md` to `docs/tasks/completed/PECTEST-004-pec-validation.md`;
4. update `docs/CURRENT_STATUS.md` with completed lifecycle evidence;
5. merge the closeout PR;
6. close PECTEST Issue #20;
