...
- The binding records Repository / Branch / Start / Task / Task-blob. The Task-blob freezes the exact executable contract used by the Executor.
...
- Implementation merges through an execution PR. Closeout is performed separately and archives the active task unchanged.
